...
func (a FileHandler) WriteAlways(fileName string, fileTime time.Time) error {
  ...
  return a.generateReferenceIndex(fileName, fileTime)
}
...
func (a FileHandler) generateReferenceIndex(fileName string, fileTime time.Time) error {
